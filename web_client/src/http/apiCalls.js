...
export async function getProductBySlugAdmin(values) {
  const res = await axiosInstance.get(`${API_PRODUCT_ADMIN}/${values.slug}`, { params: values });
  return res?.data || [];
}
